...
export function ProductCard({ product, onAddToCart, hasPromo = false, promoText = "APENAS HOJE 40%" }: ProductCardProps) {
          ...
          <div className="flex-1 flex flex-col justify-between min-w-0">
            ...
            <div className="space-y-2">
              <div>
                ...
                <div className={`text-xl font-black ${hasPromo ? 'text-orange-600' : 'text-purple-700'}`} data-testid={`text-price-${product.id}`}>
            ...
            <span className="flex items-center justify-center gap-2">
              {hasPromo ? (
                ...
                <>
                  ...
                  <span className="animate-pulse-text-soft">Adicionar ao Carrinho</span>
                </>
              )}
            </span>
          </Button>
